...
public class RewindByCat : MonoBehaviour {
    ...
    public CatAnimatorRewinder catAnimatorRewinder;

    void FixedUpdate()
    {
        if(catAnimatorRewinder.isPlayBack)                     //Change keycode for your own custom key if you want
        {
